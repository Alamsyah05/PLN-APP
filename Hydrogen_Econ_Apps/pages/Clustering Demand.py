...
st.sidebar.subheader('KMeans  & AgglomerativeClustering Algorithm')
selected_range = st.sidebar.slider("K range", 2, 20)

# st.sidebar.subheader('AgglomerativeClustering Algorithm')
# # selected_cluster = st.sidebar.number_input("Optimal Cluster", 1, 20)
# st.write(f'Optimal Cluster selected: {selected_cluster}')

st.sidebar.subheader('DBSCAN Algorithm')
selected_epsilon = st.sidebar.number_input("Epsilon Neighborhood", value=0.06)
selected_min_samples = st.sidebar.number_input("Minimum Samples", value=1)
